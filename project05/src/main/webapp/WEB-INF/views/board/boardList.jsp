		...
		<div class="container">
			...
			<nav>
				<div class="nav-wrapper cyan">
					<div class="col s12">
						<a href="index.html" class="breadcrumb">홈</a> <a
							href="boardList.html" class="breadcrumb">게시판 글목록</a>
					</div>
				</div>
			</nav>
			<!-- end of Breadcrumbs -->
						...
						<c:choose>
							<c:when test="${ pageMaker.total gt 0 }">
								...
								<c:forEach var="board" items="${ boardList }">
									<tr onclick="location.href='/board/content'"
			...
			<div class="row center">
				...
				<ul class="pagination">
					...
					<c:forEach var="i" begin="${ pageMaker.startPage }"
						...
						<li
							class="${ pageMaker.cri.pageNum == i ? 'active' : 'waves-effect' }"><a
							href="/board/list?pageNum=${ i }">${ i }</a></li>
					</c:forEach>
				...
				<form action="">
					...
					<div class="col s12 l6 offset-l3">
						<div class="input-field">
							<i class="material-icons prefix">find_in_page</i> <input
